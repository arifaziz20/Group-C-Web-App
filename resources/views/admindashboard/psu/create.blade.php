        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-indigo-900 border-b border-gray-200">
                    <form method="POST" action="{{ route('PSU-record.store') }}">
                        @csrf
                        <div class="grid grid-cols-2 gap-6">
                            <div class="grid grid-rows-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-input id="efficiency_rating" class="block mt-1 w-full" type="text" name="efficiency_rating" autofocus />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <x-input id="modular" class="block mt-1 w-full" type="text" name="modular" autofocus />
                                </div>
                                <div>
                                    <x-label for="wattage" :value="__('Wattage')" />
                                    <x-input id="wattage" class="block mt-1 w-full" type="text" name="wattage" autofocus />
                                </div>
                                <div>
